...
function afilt2 = sfilt2(anld1,anld2,fs,ax,upper,lower);
...
%                 'SampleRate', fs);
tmp = (upper - lower)/2;
filt1 = designfilt('bandpassiir', 'StopbandFrequency1', upper - 50, ...
                'PassbandFrequency1', upper, 'PassbandFrequency2', upper + tmp, ...
                'StopbandFrequency2', upper + tmp + 50, 'StopbandAttenuation1', 60, ...
                'PassbandRipple', 3, 'StopbandAttenuation2', 60, ...
                'SampleRate', fs);

filt2 = designfilt('bandpassiir', 'StopbandFrequency1', upper + tmp - 50, ...
                'PassbandFrequency1', upper + tmp, 'PassbandFrequency2', upper + tmp*2, ...
                'StopbandFrequency2', upper + tmp*2 + 50, 'StopbandAttenuation1', 60, ...
                'PassbandRipple', 3, 'StopbandAttenuation2', 60, ...
                'SampleRate', fs);                     
