...
function [afilt11 afilt12] = sfilt(alim,fs,ax,upper,lower)
...
%                 'PassbandRipple', 3, 'StopbandAttenuation2', 60, ...
%                 'SampleRate', fs);
tmp = (upper - lower)/2 + lower;
filt1 = designfilt('bandpassiir', 'StopbandFrequency1', 100, ...
                'PassbandFrequency1', lower, 'PassbandFrequency2', tmp, ...
                'StopbandFrequency2', tmp + 50, 'StopbandAttenuation1', 60, ...
                'PassbandRipple', 3, 'StopbandAttenuation2', 60, ...
                'SampleRate', fs);
            
filt2 = designfilt('bandpassiir', 'StopbandFrequency1', tmp-50, ...
                'PassbandFrequency1', tmp, 'PassbandFrequency2', upper, ...
                'StopbandFrequency2', upper + 50, 'StopbandAttenuation1', 60, ...
                'PassbandRipple', 3, 'StopbandAttenuation2', 60, ...
                'SampleRate', fs);
